<template>
  <aside class="mb-12 md:mb-0 md:w-[276px] md:mr-8 md:shrink-0 md:p-4">
    ...
    <ul class="space-y-0.5">
      <li>
        <a class="flex items-center font-medium text-sm text-gray-800 dark:text-gray-200 px-4 h-9 space-x-4 transition-colors rounded-lg bg-linear-to-tr from-white/70 to-white/50 dark:bg-linear-to-b dark:from-gray-700/50 dark:to-gray-700/40 shadow-sm shadow-black/5"
          href="#0">
